...
cat > /dev/null <<DESCRIPTION
    ...
    Usage:
        ...
        Installing ReShade for a DirectX / OpenGL game:
            Example on Back To The Future Episode 1:
                ...
                Run this script: ./reshade-linux-slim.sh
    ...
    Environment Variables:
        UPDATE_RESHADE
            ...
            ex.: UPDATE_RESHADE=0 ./reshade-linux-slim.sh
        ...
        MAIN_PATH
            ...
            ex.: MAIN_PATH=~/Documents/reshade ./reshade-linux-slim.sh
        ...
        REBUILD_MERGE
            ...
            ex.: REBUILD_MERGE=1 SHADER_REPOS="https://github.com/martymcmodding/qUINT|martymc-shaders" ./reshade-linux-slim.sh
        ...
        GLOBAL_INI
            ...
            You can also use a different ReShade.ini than the one that is created by this script,
              ...
              file, for example : GLOBAL_INI="ReShade2.ini" ./reshade-linux-slim.sh
        ...
        LINK_PRESET
            ...
            ex.: LINK_PRESET=ReShadePreset.ini ./reshade-linux-slim.sh
        ...
        RESHADE_VERSION
            ...
            ex.: RESHADE_VERSION="4.9.1" ./reshade-linux-slim.sh
        ...
        FORCE_RESHADE_UPDATE_CHECK
            ...
            ex.: FORCE_RESHADE_UPDATE_CHECK=1 ./reshade-linux-slim.sh
        ...
        RESHADE_ADDON_SUPPORT
            ...
            ex.: RESHADE_ADDON_SUPPORT=1 ./reshade-linux-slim.sh
        ...
        DELETE_RESHADE_FILES
            ...
            Disabled by default.
            ex.: DELETE_RESHADE_FILES=1 ./reshade-linux-slim.sh
        ...
        VULKAN_SUPPORT
            ...
            ex.: VULKAN_SUPPORT=1 ./reshade-linux-slim.sh
DESCRIPTION
...
SHADER_REPOS=${SHADER_REPOS:-"https://github.com/crosire/reshade-shaders|reshade-shaders|slim"}
